    ...
    m_SLAM(pSLAM)
{
    ...
    left_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "camera/infra1/image_rect_raw");
    right_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "camera/infra2/image_rect_raw");
