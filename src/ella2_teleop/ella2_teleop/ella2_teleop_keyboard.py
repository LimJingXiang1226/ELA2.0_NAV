...
as TwistStamped or Twist messages. It works best with a US keyboard layout.
---------------------------
Moving around:
        w
   a    s    d
...
a/d : increase/decrease angular velocity (MAX_ANG_VEL: ~ {MAX_ANG_VEL})
...
def main():
    ...
    # Declare the 'simulation' parameter
    ...
    if simulation:
        ...
        pub = node.create_publisher(TwistStamped, 'cmd_vel_ela2', qos)
